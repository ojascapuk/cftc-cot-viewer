/* These define the structures returned from the Socrata API for Commitment of Traders reports.
 This code defines TypeScript interfaces representing different types of Commitment of Traders (COT) reports obtained from the Socrata API. 
 It includes common fields for all reports and extends specific interfaces for financial futures, disaggregated futures, and legacy futures, 
 each with their respective fields related to trader positions, changes, percentages, and concentration levels.

These define the structures returned from the Socrata API for Commitment of Traders reports. 
The APIs return arrays of objects that look like the interfaces defined here. 
...
export type IAnyCOTReportType = 
    | IFinancialFuturesCOTReport 
    | IDisaggregatedFuturesCOTReport 
    | ILegacyFuturesCOTReport;
// Defines a type that can be any of the specific COT report interfaces.
...
// Defines a base interface for a COT report with common fields.
...
// Extends the ISocrataCOTReport interface to include fields specific to financial futures COT reports.
...
export interface IDisaggregatedFuturesCOTReport extends ISocrataCOTReport {
    ...
    pct_of_oi_nonrept_short_all: number;
    traders_tot_all: number;
    traders_prod_merc_long: number;
    traders_prod_merc_short: number;
    traders_swap_long_all: number;
    traders_swap_short_all: number;
    traders_swap_spread_all: number;
    traders_m_money_long_all: number;
    traders_m_money_short_all: number;
    traders_m_money_spread: number;
    traders_other_rept_long: number;
    traders_other_rept_short: number;
    traders_other_rept_spread: number;
    traders_tot_rept_long_all: number;
    traders_tot_rept_short_all: number;
...
// Extends the ISocrataCOTReport interface to include fields specific to disaggregated futures COT reports.
...
export interface ILegacyFuturesCOTReport extends ISocrataCOTReport {
    ...
    change_in_noncomm_spread_all: number;
    ...
    pct_of_oi_noncomm_spread_all: number;
...
// Extends the ISocrataCOTReport interface to include fields specific to legacy futures COT reports.
